                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="btn-toolbar" role="toolbar">
                                <div class="btn-group pull-right" role="group">
                                    <a class="btn btn-default" href="<?= base_url();?>AdminController/pending_requests_view">Go to pending requests <span class="glyphicon glyphicon-chevron-right"></span></a>
                                </div>
                            </div>
                            <div class="panel panel-primary">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($list as $row){
                                                ...
                                                foreach($user as $row3){
                                                    if($row3->users_id==$row->request_rejectedBy){
                                                        echo '<td><a href="#">'.$row3->users_firstname.' '.$row3->users_lastname.'</a></td>';
                                                    }
                                                }
                                                echo '<td><a class="btn btn-danger btn-xs" href="'.base_url().'AdminController/request_details_view/'.$row->request_id.'" style="width:100%;"><span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;View Details</a></td>';
                                ...
                                <p class="help-block">This is the list of rejected requests for blood, you can click the 'View Details' button to check the rejection details</p>
                            </div>
