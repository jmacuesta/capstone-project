			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a class="active" href="<?=base_url();?>UsersProfileController/MyRequests">My Requests</a>
                        </li>
                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                   <div class="panel panel-danger">
                       <div class="panel-heading"><strong>My Requests</strong></div>
                       <div class="panel-body">
                           <table class="table table-hover" id="example">
                               <thead>
                                   <tr>
                                       <td>Recipient Name</td>
                                       <td>Blood Type Needed</td>
                                       <td>Number of Interested Donors</td>
                                       <td>Donors</td>
                                   </tr>
                               </thead>
                               <tbody>
                                   ...
                                   <tr>
                                       ...
                                       <td><?=$row->request_neededBloodType;?></td>
                                       <td><?=$row->request_NumInterestedDonors;?></td>
                                       <td><?=$row->request_InterestedDonors;?></td>
                                   </tr>
                                   <?php endforeach; ?>
                               </tbody>
                           </table>
